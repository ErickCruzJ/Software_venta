...
class StoreEmpleadoRequest extends FormRequest
{
    ...
    public function messages (): array 
    {
        return[
            ...
            'calle.regex' => 'Solo se permiten letras, numero, .. -',
            'numero.required' => 'El numero exterior es obligatorio.',
            'numero.regex' => 'Solo puede contenre números, letras y guiones.',
            'CP.requierd' => 'El código postal es obligatorio.',
            'CP.digits' => 'El codigo postal debe contener exactamente 5 digitos.',
